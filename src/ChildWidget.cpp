...
bool ChildWidget::loadBoxes(const QString &fileName)
{
  ...
  if (!file.open(QFile::ReadOnly | QFile::Text))
    {
      QMessageBox::warning(this, APPLICATION_NAME, tr("Cannot read file %1:\n%2.").arg(fileName).arg(
                             file.errorString()));
      return false;
    }
  ...
  if (isModified())
    {
      ...
      ret = QMessageBox::warning(this, APPLICATION_NAME, tr("'%1' has been modified.\n"
